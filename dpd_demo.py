...
parser.add_argument('--A', default=25.0, type=float, help='repulsion amplitude, default 25.0')
parser.add_argument('--rho', default=3.0, type=float, help='density, default 3.0')
