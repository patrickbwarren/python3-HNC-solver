...
* `ndpd_liquidus.py` : estimate the liquidus as <em>p</em> = 0;
* `mbdpd_hnc.py` : various HNC variants for MB DPD, condor-enabled;
* `mbdpd_dft.py` : 'vanilla' DFT for MB DPD;
* `mbdpd_percus.py` : Percus-like DFT for MB DPD;
